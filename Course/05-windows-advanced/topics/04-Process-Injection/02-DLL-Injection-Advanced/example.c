/*
 * =============================================================================
 * DLL Injection avancée
 * =============================================================================
 * 
 * Description : Techniques avancées d'injection DLL : thread hijacking, QueueUserAPC, NtCreateThreadEx
 * 
 * Compilation :
...
int main(int argc, char *argv[]) {
    ...
    printf("[*] Module : DLL Injection avancée\n");
    printf("[*] ==========================================\n\n");
